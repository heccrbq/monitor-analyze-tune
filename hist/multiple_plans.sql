/**
 * =============================================================================================
 * Поиск запросов с несколькими планами выполнения с вычислением разницы времени работы планов 
 * =============================================================================================
 ...
 *  - loaded_plans   : количество найденных планов выполнения для запроса
 *  - last_load_time : время последнего снепшота, где был найден запрос
 *  - min_elapsed    : минимальное время выполнения запроса по одному из планов (в секундах)
 *  - max_elapsed    : максимальное время выполнения запроса по одному из планов (в секундах)
